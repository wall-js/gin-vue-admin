...
require github.com/wall-js/uni-iot/gva-plugin/iot v0.0.0

replace github.com/wall-js/uni-iot/gva-plugin/iot => ../../../gva-plugin/iot
...
require (
	...
	github.com/taosdata/driver-go/v3 v3.7.6 // indirect
